#!/bin/bash -eu
#
# Script to generate input JSON-file for the LINC pipeline.
#
# Usage: generate_json.sh <observation-dir>
#
...
SKYMODEL_DIR="${LINC_INSTALL_DIR}/skymodels"
SKYMODEL_A_TEAM="Ateam_LBA_CC.skymodel"
