...
MOUNT_DIRS="/cosma5/data/durham/dc-vand6/,/cosma/home/durham/dc-vand6/,/cosma/home/durham/dc-vand6/.local/bin,/cosma/local/singularity/3.9.2/bin"
SINGULARITY="singularity exec \
  --bind ${MOUNT_DIRS}\
  ${CWL_SINGULARITY_CACHE}/linc-20220810.sif"
